...
//       title: "Basah Creative Tim",
//     });

//     const contentString =
//       '<div class="info-window-content"><h2>Basah Creative Tim</h2>' +
...
Geocode.setApiKey("AIzaSyCEf50lu0aWK2OjjuqaKHsXbsg5-QnfOlw");
Geocode.enableDebug();
    ...
    return (
      <div className="relative w-full rounded h-600-px">
        <div style={{ padding: "1rem", margin: "0 auto", maxWidth: 1000 }}>
          ...
          <AsyncMap
            googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyCEf50lu0aWK2OjjuqaKHsXbsg5-QnfOlw&libraries=places"
            loadingElement={<div style={{ height: `100%` }} />}
